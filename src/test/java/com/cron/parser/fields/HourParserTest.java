...
public class HourParserTest {
    ...
    public void testValueUpperBoundOverflow() {
        exceptionRule.expect(ExpressionParserException.class);
        exceptionRule.expectMessage("Value 24 is above the upper limit for Field{min=0, max=23}");

        expression.parse("24", field);
    }
    ...
    public void testRangeMissingInput() {
        exceptionRule.expect(ExpressionParserException.class);
        exceptionRule.expectMessage("Input 5- is not valid for range expression for Field{min=0, max=23}");
    ...
    public void testRangeStepMissingRightInput() {
        exceptionRule.expect(ExpressionParserException.class);
        exceptionRule.expectMessage("Input 15-20/ is not valid for step expression for Field{min=0, max=23}");
    ...
    public void testRangeStepInputUnderflow() {
        exceptionRule.expect(ExpressionParserException.class);
        exceptionRule.expectMessage("Step 0 is not valid for Field{min=0, max=23}");
    ...
    public void testAnyValueStep() {
        Set<Integer> expected = Set.of(0, 10, 20);
